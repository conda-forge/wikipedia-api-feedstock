...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wikipedia-api-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13751&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wikipedia-api-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wikipedia-api` can be installed with:

```
conda install wikipedia-api
```

It is possible to list all of the versions of `wikipedia-api` available on your platform with:
